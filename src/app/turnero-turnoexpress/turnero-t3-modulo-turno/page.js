...
import LogosSection from "@/app/ver-mas/turnos/fila-unica/components/LogosSection/LogosSection";
...
export const metadata = {
    ...
    openGraph: {
        ...
        description:
            "Turnero digital con espacio para logo. Llama turnos en orden y muestra ventanillas libres. Eleva la imagen y eficiencia de tu empresa. ¡Solicita demo!",
        url: "https://landing-tecnologiaplus-nextjs.vercel.app/turnero-turnoexpress/turnero-t3-modulo-turno",
        type: "website",
    },
    twitter: {
